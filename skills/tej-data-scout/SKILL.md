...
2. **官方免費源**（以台灣為例）：公開資訊觀測站（MOPS，年報/重大訊息/股東會）、TWSE/TPEx 官網、政府開放資料平台、專利檢索（TIPO）、裁罰公開資料——與訂閱資料庫併用時注意**識別碼（統編/公司代號）能否對接**。免費源的專屬偵察與事件研究事件源整備,見姊妹 skill **public-disclosure-scout**。
