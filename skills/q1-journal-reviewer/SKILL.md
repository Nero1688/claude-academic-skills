...
動筆前先過 `references/desk-reject-checklist.md`（編輯桌面審查的殺稿訊號，過不了就先講）；各期刊家族的四軸「沒有就退」門檻、「有但薄」審稿語與台灣稿件三大落差的對策見 `references/top-journal-standards.md`，Major 的嚴重度要對得上那裡的門檻。
